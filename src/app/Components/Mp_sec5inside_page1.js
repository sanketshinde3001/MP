...
const Mp_sec5inside_page1 = ({ imagesrc1, title1, description1 }) => {
  return (
    <>
      <div className="flex justify-center m-4 md:m-11 font-fontbody ">
        <div className="container bg-orange-50 rounded-2xl flex flex-col md:flex-row mb-24 ">
          <div className="font-fontbody w-full md:w-2/4 pl-12 pr-4 md:pl-0 md:m-10 my-14">
            <h1
...
export default Mp_sec5inside_page1;
