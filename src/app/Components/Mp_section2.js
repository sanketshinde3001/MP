...
const Section = ({ imageSrc,imagewidth,imageheight, topTag, title, description ,linkHref, buttonText }) => {
  return (
    <>
    <div className={`relative md:m-0 m-5 mb-8 lg:mt-16`}>
      <div className={`border-purple-700 border-2 absolute top-6 md:top-12 left-6 md:left-36 right-8 md:right-28 md:bottom-14 -bottom-4 rounded-2xl z-20`}>          
      {topTag && (
